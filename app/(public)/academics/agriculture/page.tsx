...
export const metadata = {
  title: "Agriculture Programs | VIHIPEX University Institute",
  description: "Browse all Agriculture programs at VIHIPEX.",
};

export default function Page() {
  const category = getCategoryBySlug("agriculture");

  if (!category) {
    return (
      <main className="min-h-screen px-6 py-24 text-center">
        <h1 className="text-3xl font-semibold">Agriculture Programs</h1>
