...
export const metadata = {
  ...
  description: "Browse all Master's degree programs offered at VHIPEX.",
};

const category = {
  slug: "masters",
  name: "Master's Programs",
  description: "Explore advanced graduate degree programs built for leadership roles in industry, healthcare, and education.",
  color: "blue" as const,
  sectionBadge: "MASTER'S",
  coverImage: "https://source.unsplash.com/1400x600/?masters,graduation,university",
  ...
  if (!category.programs.length) {
    return (
      <main className="min-h-screen px-6 py-24 text-center">
        ...
        <p className="mt-4 text-slate-500">No Master's programs are available right now.</p>
      </main>
    );
  }
