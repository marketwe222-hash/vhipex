...
export const metadata = {
  title: "Other Programs | VIHIPEX University Institute",
  description: "Browse all other professional programs at VIHIPEX.",
};
  ...
  if (!category) {
    return (
      <main className="min-h-screen px-6 py-24 text-center">
        <h1 className="text-3xl font-semibold">Other Programs</h1>
