...
export const metadata = {
  title: "Education Programs | VIHIPEX University Institute",
  description: "Browse all Education programs at VIHIPEX.",
};

export default function Page() {
  const category = getCategoryBySlug("education");

  if (!category) {
    return (
      <main className="min-h-screen px-6 py-24 text-center">
        <h1 className="text-3xl font-semibold">Education Programs</h1>
